...
public enum Messages {
        ...
        EntryMessage("$6This land is claimed by $b{0}"),
        ClaimPrivacyEnabled("$6Claim privacy $benabled$6. Non-trusted players cannot enter."),
        ClaimPrivacyDisabled("$6Claim privacy $bdisabled$6. Anyone can enter."),
        ClaimProximityError("$cu cant claim an area near by a claimed area");
